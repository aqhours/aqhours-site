  ...
  function u(e, t = !1) {
    let n,
      r = document.createTreeWalker(e, NodeFilter.SHOW_ALL, {
        acceptNode: (e) => {
          var t
          return (null == (t = e.classList) ? void 0 : t.contains(a))
            ? NodeFilter.FILTER_REJECT
            : NodeFilter.FILTER_ACCEPT
        },
      }),
      i = []
    for (; (n = r.nextNode()); ) (n.originalParent = n.parentNode), i.push(n)
  ...
  let N = (e) =>
    ...
    D = async (e, t, n) => {
      let r = t[e][1],
        ...
        a = r,
        o = () => a && !a.delay
      for (; o(); ) i.push(a), o() && l++, (a = t[l] ? t[l][1] : null)
      return i.length
        ? (await N(async () => {
            for (let e of i) await M(e)
          }),
          l - 1)
        : (await n(() => N(() => M(r)), r.delay), e)
    }
  return function (e, r = {}) {
    let N = async (e, t, n = !1) => {
        J.frozen &&
      ...
      $ = () =>
        ((e) =>
          m(e)
            ? n(e.value)
            : u(e, !0).filter((e) => !(e.childNodes.length > 0)))(_),
      C = (e, t) => (
        G.add(e),
        ((e = {}) => {
          let t = e.delay
            ...
            ((e, t, n) => {
              let r = `[data-typeit-id='${e}'] .ti-cursor`,
                ...
                l = Object.entries(S).reduce(
                  (e, [t, n]) =>
                    `${e} ${t}: var(--ti-cursor-${t}, ${n || i[t]});`,
                  ''
                )
              f(
                `@keyframes blink-${e} { 0% {opacity: 0} 49% {opacity: 0} 50% {opacity: 1} } ${r} { display: inline; letter-spacing: -1em; ${l} animation: blink-${e} ${
                  t.cursorSpeed / 1e3
                }s infinite; } ${r}.with-delay { animation-delay: 500ms; } ${r}.disabled { animation: none; }`,
                e
              )
            })(Y, X, _)
      },
      P = (e) => {
        K &&
          Z &&
          (Z.classList.toggle('disabled', e),
          Z.classList.toggle('with-delay', !e))
      },
      z = () => {
      ...
      O = async (e = !0) => {
        ...
        try {
          ...
          for (let e = 0; e < n.length; e++) {
            ...
            if (!i.done) {
              if (
                (i.typeable && !J.frozen && P(!0),
                !i.deletable || (i.deletable && $().length))
              ) {
                let r = await D(e, n, N)
                Array(r - e)
                  .fill(e + 1)
      ...
      B = async (e) => {
        ...
        ;(t = e),
          ...
          ((e, t, n) => {
            let r = t[n - 1],
              i = v('.ti-cursor', e)
            ;(e = (null == r ? void 0 : r.parentNode) || e).insertBefore(
              i,
              r || null
            )
          })(_, $(), U)
      ...
      F = (e) =>
        ((e, t) => {
          ...
          t.innerHTML = ''
          let n =
            'BODY' === (null == (r = t.originalParent) ? void 0 : r.tagName)
              ? e
              : t.originalParent || e
          var r
    ...
    ;(this.break = function (e) {
      ...
      (this.destroy = function (e = !0) {
        Q.forEach(clearTimeout), (Q = []), g(e) && Z && T(Z), (J.destroyed = !0)
      }),
        ...
        let n = function (e) {
            return (
              t(e).forEach((e) => {
                var t
                return i.set(
                  Symbol(null == (t = e.char) ? void 0 : t.innerText),
                  {
                    ...e,
                  }
                )
    ...
    let K = X.cursor && !M(),
      Z = (() => {
        ...
        return (
          (e.className = a),
          K
            ? ((e.innerHTML = l(X.cursorChar).innerHTML), e)
